...
Por privacidad, WhatsApp asigna LIDs anónimos (`218077132243071@lid`) a algunos contactos en vez del JID con número (`5214422581157@s.whatsapp.net`).
...
WhatsApp multi-device anexa `:N` al JID (`5214426586883:23@s.whatsapp.net`). Normaliza siempre antes de comparar:
